...
import vo.WithMeBean;
 ...
 public class WithMeDetailAction implements Action {
	 ...
	 public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{ 
		...
		WithMeSinchungCheckService checkservice = new WithMeSinchungCheckService();//WithMeSinchungCheckService 객체 생성 신청인원 체크서비스이다
		
		WithMeBean article = DetailService.getArticle(num);//WithMeDetailService 클래스에 게시글 번호를 보내 게시글 내용을 WithMeBean 객체에  담아둔다 
