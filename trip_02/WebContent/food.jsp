...
<body>
	...
	<section>
		...
		<div class="mainbox">
			<img src="img/Lodge.jpg" width="100%" height="500" />
		</div>
		<div class="container">
			...
			<div class="sideArea">
				...
				<ul class="sideMenu">
					...
					<li><a href="place.jsp?category1=명소"><span
							class="fa fa-money"></span>명소</a></li>
					<li><a href="food.jsp?category1=맛집"><span
							class="fa fa-user-o"></span>맛집</a></li>
