...
<body>
	...
	<section>
		<div id="container">
			...
			<form action="FindIDmessage.jsp" method="post" name="findid"
				id="findid">
				<input type="hidden" id="find" name="find">
				<fieldset>
					<label for="name">Name:</label> <input type="text" id="username"
						name="username" placeholder="이름을 입력하세요" /> <label for="email">Email:</label>

					<input type="email" id="email" name="email"
						placeholder="email을 입력하세요" /> <input type="button" id="send"
						value="send" onclick="FindID()" />
				</fieldset>
			</form>
			<div id="box_mainback">
				메인으로 돌아가기: <a href="index.jsp">HOME</a>
			</div>
		</div>
	</section>
	<footer>
