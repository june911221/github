...
public class UserDao {
	...
	public void Signup(String name, String id, String password, String email, String phone, String birth,
			String postcode, String addr1, String addr2) {// DB에 회원가입정보 입력
		try {
			conn = Drive();
			stmt = conn.createStatement();
			String command = "insert into user values('" + id + "','" + name + "','" + password + "','" + email + "','"
					+ phone + "','" + birth + "','" + postcode + "','" + addr1 + "','" + addr2 + "');";
...
//System.out.println(str);
	...
	public int Userupdate(String id, String pw, String email, String phone, String post, String addr1, String addr2) {// 회원정보수정
		...
		try {
			...
			String command = null;
			if (pw == null || pw == "") {
				command = "update user set email='" + email + "',phone='" + phone + "',postcode='" + post + "',addr1='"
						+ addr1 + "',addr2='" + addr2 + "' where id='" + id + "';";
			} else {
				command = "update user set password='" + pw + "',email='" + email + "',phone='" + phone + "',postcode='"
						+ post + "',addr1='" + addr1 + "',addr2='" + addr2 + "' where id='" + id + "';";
			}
			// System.out.println(command);
